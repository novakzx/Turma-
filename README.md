...
- [~] **Fase 9 — Cadastro**: busca de escola com autocomplete e turma criável pelo próprio usuário, com pedido de entrada aprovado pelo dono, prontos e testados. Falta a parte de "verificação de estudante" pedida no brief original — proposta de abordagem em aberto com o usuário antes de implementar (é decisão de produto, não técnica).
