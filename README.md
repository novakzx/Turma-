...
- **Ainda pendente** (pedidos do mesmo usuário, não começados): trocar Claude pela Gemini no chat de estudo (aguardando o usuário passar a chave via secret do Supabase), banner de aceitar cookies (web) e notificação de "adicionar à tela inicial" (PWA).
