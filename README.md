...
- **Ainda pendente** (pedido do mesmo usuário, não começado): trocar Claude pela Gemini no chat de estudo — aguardando o usuário passar a chave via secret do Supabase (`supabase secrets set`), nunca colada em código nem no chat.
